...
<table border="1">
<tr><th>ID</th><th>Category</th><th>Organization Name</th><th>Street</th><th>City</th><th>State</th><th>ZIP</th><th>Contact</th><th>Phone</th><th>E-mail</th><th>Start Date</th><th>End Date</th><th>Total Pounds</th><th>Action</th></tr>
...
while ($result2 = $result->fetch_assoc()) {
  ...
  echo '<tr><td>' . $result2["fooddrive_id"] . '</td><td>' . $result2["orgcat_name"] . '</td><td>' . $result2["org_name"] . '</td><td>' . $result2["org_street"] . '</td><td>' . $result2["org_city"] . '</td><td>' . $result2["org_state"] . '</td><td>' . $result2["org_zip"] . '</td><td>' . $result2["org_contact"] . '</td><td>' . $result2["org_phone"] . '</td><td>' . '<a href="mailto:' . $result2["org_email"] . '">' . $result2["org_email"] . '</a></td><td>' . dateDefault($result2["fooddrive_startdate"]) . '</td><td>' . dateDefault($result2["fooddrive_enddate"]) . '</td><td>' . $result2["SUM(pickup_pounds)"] . '</td><td>';
